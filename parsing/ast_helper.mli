...
module Te:
  sig
    ...
    (* FIXME : Remove effect stuff from Te *)
...
module Eff:
  sig  
    val declaration: ?loc:loc -> ?attrs:attrs -> ?args:core_type list -> ?default_handler:effect_handler option -> str -> core_type -> effect_declaration

    val rebind: ?loc:loc -> ?attrs:attrs -> str -> lid -> effect_declaration
      
    val constructor: ?loc:loc -> ?attrs:attrs -> ?args:core_type list -> ?res:core_type -> str ->  effect_constructor
