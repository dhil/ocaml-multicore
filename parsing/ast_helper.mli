...
module Te:
  sig
    ...
    val effect_decl: ?loc:loc -> ?attrs:attrs -> ?args:core_type list -> ?default_handler:effect_handler option -> str -> core_type -> effect_constructor
    val effect_rebind: ?loc:loc -> ?attrs:attrs -> str -> lid -> effect_constructor
    val default_handler: ?loc:loc -> case list -> effect_handler
  end
